...
const FAQS = [
  {
    q: "How does matching work on Lovly?",
    a: "Lovly works on mutual interest. Swipe right to like someone, or left to pass. If they swipe right on you too, it's a match! You'll then be able to start chatting instantly."
  },
  {
    q: "What is Lovly Gold and what does it include?",
    a: "Lovly Gold is our premium subscription. It unlocks exclusive benefits including unlimited swipes, seeing who liked you in your Likes tab, rewinding accidental passes, and profile boosts."
  },
  {
  ...
  return (
    ...
    >
      <View style={[styles.header, { paddingTop: insets.top }]}>
        <TouchableOpacity onPress={() => navigation.goBack()} style={styles.backBtn} accessible={true} accessibilityLabel="Go back" accessibilityRole="button">
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          return (
            <View key={index} style={styles.faqCard}>
              <TouchableOpacity 
                ...
                accessible={true} accessibilityLabel={`Expand FAQ: ${faq.q}`} accessibilityRole="button"
              >
        ...
        <TouchableOpacity 
          ...
          disabled={submitting}
          accessible={true} accessibilityLabel="Submit Ticket" accessibilityRole="button"
        >
          {submitting ? (

      ...
      {!isPremium && (
        <View style={styles.paywallOverlay}>
          ...
          <View style={styles.paywallContent}>
            ...
            <Text style={styles.paywallDesc}>See exactly who is viewing your profile, optimize your photos, and master the algorithm with Vela Gold.</Text>

...
import { Spacing, Radius, Shadow, Gradients } from '../../theme';
...
const FALLBACK_PACKAGES = [
  ...
  { identifier: 'gold_monthly', packageType: 'MONTHLY', product: { title: 'Lovly Gold (1 Month)', priceString: '$14.99', description: 'Most popular · Billed monthly' } },
  { identifier: 'gold_six_month', packageType: 'SIX_MONTH', product: { title: 'Lovly Gold (6 Months)', priceString: '$49.99', description: 'Save 44% · Billed half-yearly' } },
];
...
export default function PremiumScreen({ navigation }) {
  ...
  const isAlreadyPremium = profile?.isPremium === true;
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <LinearGradient
          ...
          style={styles.hero}
        >
          <TouchableOpacity onPress={() => navigation.goBack()} style={styles.closeBtn} accessible={true} accessibilityLabel="Close" accessibilityRole="button">
            <Text style={styles.closeText}>✕</Text>
          </TouchableOpacity>
          <Text style={styles.heroEmoji}>👑</Text>
          <Text style={styles.heroTitle}>Lovly Gold</Text>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.comparisonContainer}>
            <Text style={styles.sectionTitle}>Free vs. Lovly Gold</Text>
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom + Spacing.md }]}>
        {isAlreadyPremium ? (
          <>
            <View style={styles.alreadyPremiumBadge}>
              <Text style={styles.alreadyPremiumText}>👑 You already have Lovly Gold!</Text>
            </View>
            <TouchableOpacity onPress={handleManageSubscription} style={styles.maybeLaterBtn} accessible={true} accessibilityLabel="Manage Subscription" accessibilityRole="button">
              <Text style={[styles.maybeLater, { color: Colors.primary, fontWeight: '700' }]}>Manage Subscription</Text>
            </TouchableOpacity>
          </>
        ) : (
          <>
            <TouchableOpacity
              ...
              accessible={true} accessibilityLabel="Purchase subscription" accessibilityRole="button"
            >
              <LinearGradient
            ...
            <TouchableOpacity onPress={() => navigation.goBack()} style={styles.maybeLaterBtn} accessible={true} accessibilityLabel="Maybe later" accessibilityRole="button">
              <Text style={styles.maybeLater}>Maybe later</Text>
            </TouchableOpacity>

            {/* Restore and Manage Subscription */}
            <View style={styles.legalLinksRow}>
              <TouchableOpacity onPress={handleRestore} disabled={isProcessing} accessible={true} accessibilityLabel="Restore Purchases" accessibilityRole="button">
                <Text style={styles.legalLink}>Restore Purchases</Text>
              </TouchableOpacity>
              <Text style={styles.legalDivider}>•</Text>
              <TouchableOpacity onPress={handleManageSubscription} accessible={true} accessibilityLabel="Manage Subscription" accessibilityRole="button">
...
const createStyles = (Colors) => StyleSheet.create({
  ...
  comparisonRowAlt: { backgroundColor: 'rgba(26, 13, 38, 0.02)' },
  comparisonRowLast: { borderBottomWidth: 0 },
  comparisonHeader: { backgroundColor: Colors.secondary, borderBottomWidth: 2, borderColor: Colors.border },
  ...
  comparisonColGold: { flex: 1.0, fontWeight: '700', backgroundColor: 'rgba(233, 75, 115, 0.04)' },
  ...
  alreadyPremiumText: { fontSize: 16, fontWeight: '800', color: Colors.primary },
});

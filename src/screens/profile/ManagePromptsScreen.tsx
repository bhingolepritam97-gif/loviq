  ...
  return (
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={handleSaveAll} style={styles.saveBtn} accessible={true} accessibilityLabel="Save prompts" accessibilityRole="button">
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.promptList}>
            ...
            <View key={prompt.id} style={styles.promptCard}>
              <View style={styles.cardHeader}>
                ...
                <View style={styles.cardActions}>
                  <TouchableOpacity style={styles.actionBtn} onPress={() => handleOpenEdit(prompt)} accessible={true} accessibilityLabel="Edit prompt" accessibilityRole="button">
                    <Text style={styles.actionEmoji}>✏️</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={[styles.actionBtn, styles.deleteAction]} onPress={() => handleDeletePrompt(prompt.id)} accessible={true} accessibilityLabel="Delete prompt" accessibilityRole="button">
                    <Text style={styles.actionEmoji}>🗑️</Text>
                  </TouchableOpacity>
                </View>
              </View>
          ...
          {prompts.length < 3 && (
            <TouchableOpacity style={styles.addSlot} onPress={handleOpenAdd} activeOpacity={0.8} accessible={true} accessibilityLabel="Add Profile Prompt" accessibilityRole="button">
        ...
        <View style={styles.modalBackdrop}>
          <View style={[styles.modalContent, { paddingBottom: insets.bottom + Spacing.xl }]}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setShowAddModal(false)} accessible={true} accessibilityLabel="Cancel Add Prompt" accessibilityRole="button">
              ...
              {PREDEFINED_QUESTIONS.map((q) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    accessible={true} accessibilityLabel={`Select prompt question: ${q}`} accessibilityRole="button"
                  >
            ...
            <View style={styles.replyBox}>
              <View style={styles.replyHeaderRow}>
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                  accessible={true} accessibilityLabel="Help me write answer with AI" accessibilityRole="button"
                >
        ...
        <View style={styles.modalBackdrop}>
          <View style={[styles.modalContent, { paddingBottom: insets.bottom + Spacing.xl }]}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setShowEditModal(false)} accessible={true} accessibilityLabel="Cancel Edit Prompt" accessibilityRole="button">
                <Text style={styles.modalCloseText}>Cancel</Text>
              </TouchableOpacity>
            </View>
...
const createStyles = (Colors) => StyleSheet.create({
  ...
  promptCard: { backgroundColor: Colors.surface, borderRadius: Radius.xl, padding: Spacing.xl, borderWidth: 1, borderColor: Colors.border, ...Shadow.sm },

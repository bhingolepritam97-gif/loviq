  ...
  const handleContinue = async () => {
    ...
    try {
      if (tab === 'phone') {
        ...
        // Navigate to Password screen directly for email/password auth flow
        setTimeout(() => {
    ...
    >
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom + Spacing.xl }]}>
        <TouchableOpacity 
          ...
          accessible={true}
          accessibilityRole="button"
          accessibilityLabel={i18n.t('phone.continue')}
        >
          <LinearGradient
...
const createStyles = (Colors) => StyleSheet.create({
  ...
  tab: { flex: 1, flexDirection: 'row', height: 40, borderRadius: Radius['2xl'], alignItems: 'center', justifyContent: 'center', gap: 6 },
  ...
  countryCode: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surface, borderRadius: Radius['2xl'], borderWidth: 1, borderColor: Colors.border, paddingHorizontal: Spacing.md, height: 52, gap: 4 },

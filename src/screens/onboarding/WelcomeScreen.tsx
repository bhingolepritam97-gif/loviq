...
const createStyles = (Colors) => StyleSheet.create({
  ...
  scrollContent: { flexGrow: 1, justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: Spacing.xl },
  ...
  socialBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', height: 48, borderRadius: Radius.lg, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.1)', backgroundColor: 'rgba(255, 255, 255, 0.05)', gap: Spacing.xs },
  socialBtnText: { color: '#FFFFFF', fontSize: 13, fontWeight: '600' },

  loginContainer: { paddingVertical: Spacing.sm },

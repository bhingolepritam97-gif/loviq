...
export const subscribeToPotentialMatches = (
  ...
  DeckCache._checkAndRefetch = checkAndRefetch;
...
export const notifyDeckSwipe = () => {
  if (typeof DeckCache._checkAndRefetch === 'function') {
    DeckCache._checkAndRefetch();
  }
};

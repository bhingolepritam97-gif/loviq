...
const MOCK_PACKAGES = [
  { identifier: 'gold_yearly', packageType: 'ANNUAL', product: { title: 'Lovly Gold (1 Year)', priceString: '$59.99', description: 'Billed annually at $4.99/mo' } },
  { identifier: 'gold_biannual', packageType: 'SIX_MONTH', product: { title: 'Lovly Gold (6 Months)', priceString: '$47.99', description: 'Billed every 6 months at $7.99/mo' } },
  { identifier: 'gold_monthly', packageType: 'MONTHLY', product: { title: 'Lovly Gold (1 Month)', priceString: '$12.99', description: 'Billed monthly' } },
];

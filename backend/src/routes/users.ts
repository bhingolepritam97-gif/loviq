...
router.get("/me/profile-score", requireAuth, ctrl.getProfileScore);
router.get("/me/analytics", requireAuth, ctrl.getMyAnalytics);
router.post("/me/ai-prompt-feedback", requireAuth, ctrl.getAiPromptFeedback);
router.post("/me/travel", requireAuth, ctrl.travelToLocation);
router.post("/me/appeal", requireAuth, ctrl.appealSuspension);
